...
def pancakes(n_pts=100, n_cor=2, n_anticor=2, n_noise=2, minor_fraction=0.5, random_fraction=0.5, marker_fraction=0.9, noise_level=0.1):
    ...
    labs[:np.floor(n_pts*minor_fraction).astype('int')] = 'marker'
